...
helloTransform.add new Two.Sprite(image: "https://upload.wikimedia.org/wikipedia/en/6/65/Hello_logo_sm.gif")
worldTransform.add new Two.Sprite(image: "http://img.talkandroid.com/uploads/2012/08/World-300x305.jpg")
