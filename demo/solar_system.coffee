...
sun = new Two.RenderNode
  renderable: new Two.Sprite(image: "/demo/assets/sun.jpg")
  width: 200
  height: 200

mercury = new Two.RenderNode
  renderable: new Two.Sprite(image: "/demo/assets/mercury.jpg")
  width: 20
  height: 20

venus = new Two.RenderNode
  renderable: new Two.Sprite(image: "/demo/assets/venus.jpg")
  width: 60
  height: 60

earth = new Two.RenderNode
  renderable: new Two.Sprite(image: "/demo/assets/earth.png")
  width: 50
  height: 50

moon = new Two.RenderNode
  renderable: new Two.Sprite(image: "/demo/assets/moon.jpg")
  width: 20
  height: 20

mars = new Two.RenderNode
  renderable: new Two.Sprite(image: "/demo/assets/mars.jpg")
  width: 30
  height: 30
